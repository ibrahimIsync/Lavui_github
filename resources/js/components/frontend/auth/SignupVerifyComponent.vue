<template>
    ...
    <div class="w-full max-w-1xl mx-auto rounded-2xl flex overflow-hidden gap-y-6 bg-white shadow-card mb-24 sm:mb-0">
        <form class="w-full p-6" @submit.prevent="save">
            <div class="text-center mb-8 relative">
                <h3 class="capitalize text-2xl mb-2 font-bold text-primary">تسجيل الدخول</h3>
                <!--                <h3 class="capitalize text-2xl mb-2 font-bold text-primary">{{ $t('label.verify_email') }}</h3>-->
            </div>
            <div class="mb-6">
