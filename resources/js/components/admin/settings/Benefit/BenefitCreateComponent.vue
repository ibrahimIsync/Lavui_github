                ...
                <form @submit.prevent="save">
                    <div class="form-row">
                        <div class="form-col-12 sm:form-col-6">
                            ...
                            <input v-model="props.form.title_en" type="text" id="title" class="db-field-control" />
                        ...
                        <div class="form-col-12 sm:form-col-6">
                            ...
                            <input v-model="props.form.title_ar" type="text" id="title" class="db-field-control" />
                            <small class="db-field-alert" v-if="errors.title">{{
                                    errors.title[0]
                                }}</small>
                        </div>
