...
use App\Http\Controllers\Admin\CustomCollectionController;
use App\Http\Controllers\Admin\GroupController;
use App\Http\Controllers\Admin\NewArrivalController;
use App\Http\Controllers\Admin\ProductStoryController;
use App\Http\Controllers\Admin\ProductTrendController;
use App\Http\Controllers\Admin\TextBannerController;
use App\Http\Controllers\Frontend\TamaraController;
...
use App\Http\Controllers\Frontend\CustomCollectionController as FrontendCustomCollectionController;
use App\Http\Controllers\Frontend\BannerController as FrontendBannerController;
use App\Http\Controllers\Frontend\TrendingProductController as FrontendTrendingProductController;
use App\Http\Controllers\Frontend\NewArrivalController as FrontendNewArrivalController;
use App\Http\Controllers\Frontend\ProductStoryController as FrontendProductStoryController;
...
Route::post('/create-payment', [TamaraController::class, 'createPayment']);
Route::get('/success-payment', [TamaraController::class, 'captureOrder']);
Route::get('/fail-payment', [TamaraController::class, 'failPayment']);
...
Route::prefix('profile')->name('profile.')->middleware(['auth:sanctum', 'localization'])->group(function () {
...
Route::prefix('admin')->name('admin.')->middleware(['auth:sanctum'])->group(function () {
    ...
    Route::prefix('setting')->name('setting.')->group(function () {
        ...
        Route::prefix('product-category')->name('product-category.')->group(function () {
            ...
            Route::post('/{productCategory}', [ProductCategoryController::class, 'update']);
        ...
        Route::prefix('product-brand')->name('product-brand.')->group(function () {
            ...
            Route::post('/{brand}', [ProductBrandController::class, 'update']);
        });
        ...
        Route::prefix('social-media')->name('social-media.')->group(function () {
            ...
            Route::post('/', [SocialMediaController::class, 'update']);
        });
        ...
        Route::prefix('slider')->name('slider.')->group(function () {
            ...
            Route::post('/{slider}', [SliderController::class, 'update']);
        });
        ...
        Route::prefix('benefit')->name('benefit.')->group(function () {
            ...
            Route::post( '/{benefit}', [BenefitController::class, 'update']);
...
//        Route::get('/purchasable-product', [ProductController::class, 'purchasableProducts']);
    ...
    Route::prefix('product-section')->name('product-section.')->group(function () {
        ...
        Route::get('{productSection}', [ProductSectionController::class, 'show']);
        Route::post('/', [ProductSectionController::class, 'store']);
        Route::post('/{productSection}', [ProductSectionController::class, 'update']);
    ...
    Route::prefix('custom-collection')->name('custom-collection.')->group(function () {
        Route::get('/', [CustomCollectionController::class, 'index']);
        Route::get('{collection}', [CustomCollectionController::class, 'show']);
        Route::post('/', [CustomCollectionController::class, 'store']);
        Route::delete('{collection}', [CustomCollectionController::class, 'destroy']);
        Route::post('{collection}', [CustomCollectionController::class, 'update']);
    });
    ...
    Route::prefix('badge')->name('badge.')->group(function () {
        ...
        Route::post('{badge}', [BadgeController::class, 'update']);
    });
    ...
    Route::prefix('product-trend')->name('product-trend.')->group(function () {
        Route::get('/', [ProductTrendController::class, 'index']);
        Route::post('/', [ProductTrendController::class, 'store']);
        Route::get('{product}', [ProductTrendController::class, 'show']);
        Route::delete('{product}', [ProductTrendController::class, 'destroy']);
        Route::post('{product}', [ProductTrendController::class, 'update']);
    });

    Route::prefix('product-story')->name('product-story.')->group(function () {
        Route::get('/', [ProductStoryController::class, 'index']);
        Route::post('/', [ProductStoryController::class, 'store']);
        Route::get('{product}', [ProductStoryController::class, 'show']);
        Route::delete('{product}', [ProductStoryController::class, 'destroy']);
        Route::post('{product}', [ProductStoryController::class, 'update']);
    });

    Route::prefix('new-arrival')->name('new-arrival.')->group(function () {
        Route::get('/', [NewArrivalController::class, 'index']);
        Route::post('/', [NewArrivalController::class, 'store']);
        Route::get('{product}', [NewArrivalController::class, 'show']);
        Route::delete('{product}', [NewArrivalController::class, 'destroy']);
        Route::post('{product}', [NewArrivalController::class, 'update']);
    });
    ...
    Route::prefix('textBanner')->name('textBanner.')->group(function () {
        Route::get('/', [TextBannerController::class, 'index']);
        Route::get('/{textBanner}', [TextBannerController::class, 'show']);
        Route::post('/', [TextBannerController::class, 'store']);
        Route::post('/{textBanner}', [TextBannerController::class, 'update']);
        Route::delete('/{textBanner}', [TextBannerController::class, 'destroy']);
    });

});

Route::prefix('frontend')->name('frontend.')->middleware(['localization'])->group(function () {
    Route::prefix('setting')->name('setting.')->group(function () {
    ...
    Route::prefix('contact')->name('contact.')->group(function () {
        Route::post('/', [FrontendContactController::class, 'create']);
    });

    Route::prefix('custom-collection')->name('custom-collection.')->group(function () {
        Route::get('/', [FrontendCustomCollectionController::class, 'index']);
        Route::get('{collection:slug}', [FrontendCustomCollectionController::class, 'show']);
    });

    Route::prefix('banner')->name('banner.')->group(function () {
        Route::get('/', [FrontendBannerController::class, 'index']);
    });

    Route::prefix('trending-products')->name('trending-products.')->group(function () {
        Route::get('/', [FrontendTrendingProductController::class, 'index']);
    });

    Route::prefix('product-stories')->name('product-stories.')->group(function () {
        Route::get('/', [FrontendProductStoryController::class, 'index']);
    });

    Route::prefix('new-arrival')->name('new-arrival.')->group(function () {
        Route::get('/', [FrontendNewArrivalController::class, 'index']);
    });
