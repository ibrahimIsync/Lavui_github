...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->call(TextBannerTableSeeder::class);
        ...
        $this->call(CustomCollectionTableSeeder::class);
        $this->call(ProductTrendTableSeeder::class);
        $this->call(ProductStoryTableSeeder::class);
        $this->call(NewArrivalTableSeeder::class);
